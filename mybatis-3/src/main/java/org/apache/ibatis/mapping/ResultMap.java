...
public class ResultMap {
  ...
  /**
   * resultMap下的id节点
   * 比如<id property="id" column="user_id" />
   */
  ...
  /**
   * resultMap下的property节点
   * 比如<result property="password" column="hashed_password"/>
   */
  ...
  /**
   * autoMapping属性,这个属性会覆盖全局的属性 autoMappingBehavior
   */
  ...
  public static class Builder {
    ...
    public ResultMap build() {
      ...
      for (ResultMapping resultMapping : resultMap.resultMappings) {
        ...
        // 判断是否嵌套了association或者collection, nestedResultMapId是在buildResultMappingFromContext的时候通过读取
        // 节点的resultMap属性得到的或者内嵌resultMap的时候自动计算得到的。注：这里的resultSet没有地方set进来,DTD中也没有看到，
